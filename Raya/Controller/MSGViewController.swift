...
class MSGViewController: MessagesViewController {
 ...
 //MARK:- Actions
    ...
    func send(text: String?, photo: UIImage?, video: Video?, audio: String?, location: String?, audioDuration: Float = 0.0) {
        ...
        // location in database on mac موقع الداتا بيس ع الجهاز عندي عن طريق طباعته
        ...
        //https://realm.io الرابط هاض بشرح اكثر عنها
        // /Users/yahyahajali/Library/Developer/CoreSimulator/Devices/C0D67FFB-9AC3-4B15-9845-AE097AA0014C/data/Containers/Data/Application/9DAE568E-D791-451B-8AAE-A039119C556A/Documents/default.realm
        //s هيو احطياط برضو
